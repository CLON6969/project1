...
<header class="hero">
    ...
    <img src="{{ asset('/public/storage/uploads/pics/' . $personal_solution->background_picture) }}" alt="background">
    <div class="overlay">
...
<div class="first-bottom-section">
    <div class="image-container">
        <img src="{{ asset('/public/storage/uploads/pics/' . $personal_solution->picture1) }}" alt="logo">
    </div>
