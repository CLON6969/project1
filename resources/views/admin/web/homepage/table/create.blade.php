...
<div class="max-w-3xl mx-auto px-6 py-10 bg-white rounded-xl shadow-lg border border-gray-200 text-gray-900">
    <h2 class="text-2xl font-bold text-green-700 mb-6">Add Homepage Content</h2>

    {{-- Include session alerts --}}
@include('partials.alerts')

    <form action="{{ route('admin.web.homepage.table.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
        @csrf
