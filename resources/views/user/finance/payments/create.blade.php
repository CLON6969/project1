...
<div class="payment-container">
  ...
  @if(session('success'))
    <div style="background: #d4edda; color: #155724; padding: 10px; margin-bottom: 1rem; border-radius: 5px;">
      {{ session('success') }}
    </div>
  @endif

  @if($errors->any())
    <div class="alert" style="background: #600202; color: #ffffff; padding: 10px; margin-bottom: 1rem; border-radius: 5px;">
  ...
  <form method="POST" action="{{ route('user.finance.payments.submit_payment') }}" enctype="multipart/form-data">
    @csrf
