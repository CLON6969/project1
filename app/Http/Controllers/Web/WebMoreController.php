...
class WebMoreController extends Controller
{
    public function edit()
    {
        $solution = more::first(); // Assumes only one row
        return view('admin.web.more.edit', compact('solution'));
    }
    ...
    public function update(Request $request)
    {
        ...
        return redirect()->route('admin.web.more.edit')->with('success', 'More solution content updated successfully.');
    }
}
